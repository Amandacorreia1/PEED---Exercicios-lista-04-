'''Escreva um programa que leia uma lista de nomes e crie uma lista encadeada 
dupla com esses nomes em ordem alfabética.''' 
...
def listaDeNomes():
    nomes = []
    qnt = int(input('Informe a quantidade de nomes que deseja adicionar na lista: '))
    for i in range (qnt):
